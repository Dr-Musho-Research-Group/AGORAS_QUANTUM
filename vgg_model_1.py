...
df_nonZero['target'] = 'overdose'
df_Zero = df.loc[df['Count'] == 0]
df_Zero['target'] = 'no overdose'
...
opt = SGD(learning_rate =0.00001 , clipvalue = 5)
...
check = model.evaluate_generator(generator=valid_generator, steps=STEP_SIZE_VALID)
